...
public class NetworkResponse<T: JSONParsable> {
    ...
    /// A reference to the original request for this response.
    ...
    public init(response: URLResponse? = nil, error: Error? = nil, data: Data? = nil, request: URLRequest? = nil) {
...
//    public init(object: T.ParsedObject? = nil, response: HTTPURLResponse? = nil, error: Error? = nil, data: Data? = nil, request: URLRequest? = nil) {
//        self.object = object
