...
class NetworkResponse<T: JSONParsable> {
    ...
    init(object: T.ParsedObject? = nil, response: HTTPURLResponse? = nil, error: Error? = nil, data: Data? = nil) {
        self.object = object
